...
//        </div>
/* 若想在单击文档任何位置时，关闭对话框请在文本框弹出日期的代码处加上 _calendar_show = true;
	<input type="text" onclick="_calendar_show = true;new Calendar().show(this);" >
	document.onclick=function(e)
	{
		if ( _calendar_show == false )
			calendar.hide();
		_calendar_show = false;
	}
